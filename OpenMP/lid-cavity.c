...
void apply_boundary() {
    ...
    #pragma omp atomic
    total_time_apply_boundary += omp_get_wtime() - start_time;
}
...
void build_rhs() {
    ...
    #pragma omp atomic
    total_time_build_rhs += omp_get_wtime() - start_time;
}
...
void solve_poissons() {
    ...
    free_2d_array(pn);
    #pragma omp atomic
    total_time_solve_poissons += omp_get_wtime() - start_time;
}
...
void update_velocities() {
    ...
    #pragma omp atomic
    total_time_update_velocities += omp_get_wtime() - start_time;
}
